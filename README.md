...
The Pages workflow publishes the dependency-free `practice-relay/apps/web/src/`
tree at `/practice-relay/`. Relative asset paths keep the artifact subpath-safe,
and hosted demo mode uses sanitized fixtures without contacting the API.
