...
## 2. Install and regenerate portable evidence
...
Inspect the regenerated HTML snapshots and the affected application locally.
Check visible names, alpha status, fallback states, clipping, private data, and
unsupported claims. The checked-in PNG gallery is curated release material and
is not regenerated by repository automation.
...
The strict gate requires a configured confidential security route, available
Git metadata, and a clean worktree.
